...
// ============================================================
// INSTRUKSI UNTUK ANGGOTA SATU:
// Ganti semua data di bawah ini dengan informasi kalian sendiri!
// ============================================================

const profileData = {
  namaLengkap: "Nama Lengkap Anggota Satu",
  kelas: "Kelas A / TI-01",
  jurusan: "Teknik Informatika",
  prodi: "S1 Teknik Informatika",
  domisili: "Malang, Jawa Timur",
  // Ganti URL foto dengan link foto profil kamu (bisa dari Google Drive/Imgur/etc)
  // atau hapus bagian foto dan gunakan inisial saja
  fotoProfil: null, // Contoh: "https://i.imgur.com/xxxxx.jpg"
  inisial: "AS", // Inisial nama untuk placeholder foto
  warnaTema: "from-blue-500 to-cyan-500", // Warna gradient avatar
  tentangDiri: `
    ...
    khususnya di Indonesia. Saya juga memiliki impian untuk membangun startup teknologi 
    yang dapat memecahkan masalah nyata di lingkungan sekitar saya.
  `,
  skills: ["React.js", "JavaScript", "Tailwind CSS", "Git & GitHub", "Node.js"],
  sosialMedia: {
...
// ============================================================
// JANGAN UBAH KODE DI BAWAH INI (Kecuali untuk styling)
// ============================================================

export default function AnggotaSatu() {
  return (
          ...
          <div className="relative p-8 pt-16">
            <div className="flex flex-col sm:flex-row items-start sm:items-end gap-6">
              ...
              <div className="flex gap-2">
                ...
                {profileData.sosialMedia.linkedin && (
                  <a href={profileData.sosialMedia.linkedin} target="_blank" rel="noopener noreferrer"
                    className="w-10 h-10 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl flex items-center justify-center text-slate-400 hover:text-blue-400 transition-all">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {profileData.skills.map((skill, i) => (
                  <span key={i} className="bg-blue-500/10 border border-blue-500/20 text-blue-300 text-xs font-medium px-3 py-1.5 rounded-full">
                    {skill}
                  </span>
                ))}
              </div>
