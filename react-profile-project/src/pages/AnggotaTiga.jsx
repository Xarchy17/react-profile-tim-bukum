...
// ============================================================
// INSTRUKSI UNTUK ANGGOTA TIGA:
// Ganti semua data di bawah ini dengan informasi kalian sendiri!
// ============================================================

const profileData = {
  namaLengkap: "Nama Lengkap Anggota Tiga",
  kelas: "Kelas A / TI-01",
  ...
  fotoProfil: null,
  inisial: "AT",
  warnaTema: "from-violet-500 to-pink-500",
  tentangDiri: `
    ...
    Saya tertarik pada bidang UI/UX Design dan ingin menggabungkan kreativitas desain 
    dengan kemampuan coding untuk menciptakan produk digital yang tidak hanya fungsional 
    tetapi juga memiliki user experience yang luar biasa bagi penggunanya.
  `,
  skills: ["TypeScript", "Figma", "Tailwind CSS", "Git & GitHub", "Next.js"],
  sosialMedia: {
...
export default function AnggotaTiga() {
  return (
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {profileData.skills.map((skill, i) => (
                  <span key={i} className="bg-violet-500/10 border border-violet-500/20 text-violet-300 text-xs font-medium px-3 py-1.5 rounded-full">
                    {skill}
                  </span>
                ))}
              </div>
          ...
          <div className="md:col-span-2">
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 h-full">
              <h2 className="font-display text-white text-xl font-bold mb-6 flex items-center gap-3">
                <span className="w-8 h-8 bg-violet-500/20 rounded-lg flex items-center justify-center text-violet-400 text-sm">✦</span>
                Tentang Diri
              </h2>
              <div className="space-y-4">
